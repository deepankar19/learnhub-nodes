    ...
    <div className="min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-4 leading-relaxed">
              Founded in 2020, learndev started with a simple idea: everyone deserves access to
            ...
            <p className="text-gray-600 leading-relaxed">
              Today, more than 10 million students across 190+ countries use learndev to learn new
          ...
          <div className="bg-gradient-to-br from-blue-100 to-indigo-100 rounded-2xl p-8">
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="text-center">
                <div className="text-4xl font-bold text-blue-600 mb-1">190+</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              These principles guide everything we do at learndev
            </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-xl mx-auto">
            The passionate people behind learndev
          </p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {team.map((member) => (
            <div key={member.name} className="text-center group">
              <div className="w-24 h-24 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform shadow-lg">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8 text-center">
              <div>
                ...
                <p className="text-sm text-gray-500">support@learndev.com</p>
              </div>
              <div>
                <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mx-auto mb-2">
                  <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
